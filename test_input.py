...
parser = argparse.ArgumentParser(description='Generate FlyBy features and print input shape', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
...
# 打印模型输入的形状
print("Model input shape:", np.shape(img_np))
...
end_time = time.time()
print("Execution time took:", (end_time - start_time), "seconds")